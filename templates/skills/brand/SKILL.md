---
name: brand
description: <One line naming the policy and when it applies. Example: Apply the organization's Brand policy to any change that touches <area>. Use during Design, Build, and Review.>
metadata:
  owner: "Design lead"
...
Brand policy without a human having to remember the rules.
